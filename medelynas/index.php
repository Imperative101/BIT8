...
<form class="form" action="" method="POST">
        <div class="form-group row">
         ...
         <div class="form-group row">
            <label class="col-sm-2 col-form-label" >plant is yearling</label>
            <div class="col-sm-4">
                <input class="form-control" type="text" name="is_yearling" value="<?= (isset($plant))? $plant['is_yearling'] : "" ?>">
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-2 col-form-label" >plants quantity</label>
            <div class="col-sm-4">
    ...
    <?php if(!isset($plant)){
            ...
            echo '
            <button class="btn btn-info" type="submit" name="update" value="'.$plant['id'].'">update plant</button>';
    } ?>
    </form>
    ...
    <table class="table">
        ...
        <?php $count = 0; foreach ($_SESSION['cars'] as $plant) {  ?>
            <tr>
